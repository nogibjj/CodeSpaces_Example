...
class NNHybridFiltering(nn.Module):
    ...
    def __init__(self, n_users, n_items, n_sentiments, embdim_users, embdim_items, embdim_u_sentiments, embdim_i_sentiments, n_activations,
                 rating_range):
        super().__init__()
        ...
        self.fc1 = nn.Linear(embdim_users + embdim_items + embdim_u_sentiments + embdim_i_sentiments, n_activations)
